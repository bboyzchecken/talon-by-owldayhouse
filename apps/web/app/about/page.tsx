...
const reasons = [
  ...
  { icon: Users, title: "ทีมงานคนไทยดูแลต่อ", text: "คุยภาษาเดียวกัน แก้ไขไว ดูแลต่อเนื่อง ไม่หายตัวหลังส่งงาน" },
    ...
    <main className="mx-auto max-w-5xl px-6 py-20">
      ...
      <div className="mt-8 grid items-center gap-10 lg:grid-cols-2">
        <div className="space-y-4 text-muted">
          ...
          <p>
            เราไม่ได้แค่ทำเว็บให้เสร็จแล้วจากไป — แต่อยู่ดูแล แก้ไข และพัฒนาต่อด้วยทีมงานชุดเดิม
